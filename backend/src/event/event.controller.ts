...
export class EventController {
  ...
  async getVendorDashboardSumarry(
    @Param('vendorid') vendorId: string,
  ): Promise<any> {
  ...
  @Post('/toggleplatformfee/:id')
  async toggleplatformfee(@Param('id') id: string) {
    return this.eventService.togglePlatformFee(id);
  }
