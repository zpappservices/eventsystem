        ...
        <ul className="text-[#A5D4B8] flex flex-col text-[16px]">
          ...
          >
            {pathname === "/dashboard" ? (
              <li className="text-[#FF7F50] flex gap-x-4 items-center bg-baseWhite p-3 rounded-l-full transition-all">
                <IoMenuOutline color="#FF7F50" size={22} onClick={toggleMenu} className="" />
                Dashboard
              </li>
            ) : (
              <li className="text-black flex gap-x-4 items-center p-3 rounded-l-full transition-all">
                <IoMenuOutline color="#000" size={22} onClick={toggleMenu} className="" />
                Dashboard
              </li>
            )}
          </Link>
          ...
          >
            {pathname === "/dashboard/createevent" ? (
              <li className="text-[#FF7F50] flex gap-x-4 items-center bg-baseWhite p-3 rounded-l-full transition-all">
                <LuCalendarDays color="#FF7F50" size={20} onClick={toggleMenu} className="" />
                Create Event
              </li>
            ) : (
              <li className="text-black flex gap-x-4 items-center p-3 rounded-l-full transition-all">
                <LuCalendarDays color="#000" size={20} onClick={toggleMenu} className="" />
                Create Event
              </li>
            )}
          </Link>
          ...
          >
            {pathname === "/dashboard/eventanalysis" ? (
              <li className="text-[#FF7F50] flex gap-x-4 items-center bg-baseWhite p-3 rounded-l-full transition-all">
                <IoAnalytics color="#FF7F50" size={20} onClick={toggleMenu} className="" />
                Event Analysis
              </li>
            ) : (
              <li className="text-black flex gap-x-4 items-center p-3 rounded-l-full transition-all">
                <IoAnalytics color="#000" size={20} onClick={toggleMenu} className="" />
                Event Analysis
              </li>
            )}
          </Link>
          ...
          >
            {pathname === "/dashboard/payout" ? (
              <li className="text-[#FF7F50] flex gap-x-4 items-center bg-baseWhite p-3 rounded-l-full transition-all">
                <FaMoneyBills color="#FF7F50" size={20} onClick={toggleMenu} className="" />
                Payout
              </li>
            ) : (
              <li className="text-black flex gap-x-4 items-center p-3 rounded-l-full transition-all">
                <FaMoneyBills color="#000" size={20} onClick={toggleMenu} className="" />
                Payout
              </li>
            )}
          </Link>
          ...
          >
            {pathname === "/dashboard/profile" ? (
              <li className="text-[#FF7F50] flex gap-x-4 items-center bg-baseWhite p-3 rounded-l-full transition-all">
                <CgProfile color="#FF7F50" size={20} onClick={toggleMenu} className="" />
                My Profile
              </li>
            ) : (
              <li className="text-black flex gap-x-4 items-center p-3 rounded-l-full transition-all">
                <CgProfile color="#000" size={20} onClick={toggleMenu} className="" />
                My Profile
              </li>
            )}
          </Link>
          ...
          >
            {pathname === "/dashboard/settings" ? (
              <li className="text-[#FF7F50] flex gap-x-4 items-center bg-baseWhite p-3 rounded-l-full transition-all">
                <AiFillSetting color="#FF7F50" size={20} onClick={toggleMenu} className="" />
                Account Settiings
              </li>
            ) : (
              <li className="text-black flex gap-x-4 items-center p-3 rounded-l-full transition-all">
                <AiFillSetting color="#000" size={20} onClick={toggleMenu} className="" />
                Account Settiings
              </li>
            )}
          </Link>
          ...
          >
            {pathname === "/dashboard/help" ? (
              <li className="text-[#FF7F50] flex gap-x-4 items-center bg-baseWhite p-3 rounded-l-full transition-all">
                <TfiHelpAlt color="#FF7F50" size={20} onClick={toggleMenu} className="" />
                Need Help ?
              </li>
            ) : (
              <li className="text-black flex gap-x-4 items-center p-3 rounded-l-full transition-all">
                <TfiHelpAlt color="#000" size={20} onClick={toggleMenu} className="" />
                Need Help ?
              </li>
            )}
          </Link>
          ...
          >
            {pathname === "/dashboard/logout" ? (
              <li className="text-[#FF7F50] flex gap-x-4 items-center bg-baseWhite p-3 rounded-l-full transition-all">
                <FiLogOut color="#FF7F50" size={20} onClick={toggleMenu} className="" />
                Logout
              </li>
            ) : (
              <li className="text-black flex gap-x-4 items-center p-3 rounded-l-full transition-all">
                <FiLogOut color="#000" size={20} onClick={toggleMenu} className="" />
                Logout
              </li>
            )}
          </Link>
